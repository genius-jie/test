...
$srt=$_SESSION['currentUser']->getDisplayName();
$rrr=$_SESSION['testprojectID'];

$mysqli = new mysqli("localhost", "root", "", "testlink");
$mysqli->query("SET NAMES UTF8");
$result=$mysqli->query("SELECT * from loginlog where loginlog.username='".$srt."';");
if($result->num_rows!=0){
	$mysqli->query("update loginlog set  loginlog.defaultobj='".$rrr."'where loginlog.username='".$srt."';");
}else{
	$mysqli->query("insert into loginlog(username,defaultobj) values('".$srt."','".$rrr."');");
}
