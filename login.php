...
switch($args->action) 
{
  ...
  break;
	...
	case 'loginform':
		...
		parse_str($query_str);
		if ($note==logout){
		redirect("https://sitetest.tf56.com/openssoWeb/opensso/login?clientNo=1&redirectUrl=http://localhost/testlink-1.9.18/loginoutsso.php");
		}
		redirect("https://sitetest.tf56.com/openssoWeb/opensso/login?clientNo=1&redirectUrl=http://localhost/testlink-1.9.18/loginsso.php");
		break;
}
