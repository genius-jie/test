...
<div class="vertical_menu" style="float: right; margin:0px 0px 10px 10px;width: 320px;">
	{if $gui->num_active_tplans > 0}
     ...
     {*-----张立杰删除掉右上角图标include file="inc_help.tpl" helptopic="hlp_testPlan" show_help_icon=true 
...
<div class="list-group-item" style="{$aStyle}">
       		<a href="{$gui->launcher}?feature=planAddTC"   style="float:left;color:#555; text-decoration: none;">{$labels.href_add_remove_test_cases}</a>
			     {include file="inc_help6.tpl" helptopic="hlp_planAddTC" show_help_icon=true 
	              inc_help_style="float:left;margin:5px 0px 0px 5px"}
              <div style="clear:both"></div>
              </div>
	    <div class="list-group-item" style="{$aStyle}">
       		<a href="{$gui->launcher}?feature=tc_exec_assignment"   style="float:left;color:#555; text-decoration: none;">{$labels.href_tc_exec_assignment}</a>
			     {include file="inc_help7.tpl" helptopic="hlp_tc_exec_assignment" show_help_icon=true 
	              inc_help_style="float:left;margin:5px 0px 0px 5px"}
              <div style="clear:both"></div>
              </div>
