...
<form method="post" enctype="multipart/form-data" action="{$SCRIPT_NAME}">
  ...
  <td> <select name="importType">
	     ...
	     <a href="http://127.0.0.1/testlink-1.9.18/docs/model.xls" download="Excel导入模板.xls">(下载EXCEL模板)</a> 
	   	<a href="http://127.0.0.1/testlink-1.9.18/docs/xmind_model.xmind" download="Xmind导入模板.xmind">(下载XMIND模板)</a>
	</td>
	</tr>
