 ...
 */
$tlCfg->log_path = 'C:\xampp\htdocs\testlink-1.9.17/logs/';
...
$tlCfg->testcase_cfg->search->max_qty_for_display=500;
...
$g_repositoryPath = 'C:\xampp\htdocs\testlink-1.9.17/upload_area/';
/**
...
$tlCfg->tree_filter_cfg->testcases->execution_mode->filter_testcase_name = DISABLED;
$tlCfg->tree_filter_cfg->testcases->execution_mode->filter_toplevel_testsuite = DISABLED;
$tlCfg->tree_filter_cfg->testcases->execution_mode->filter_keywords = DISABLED;
$tlCfg->tree_filter_cfg->testcases->execution_mode->filter_priority = ENABLED;
$tlCfg->tree_filter_cfg->testcases->execution_mode->filter_execution_type = DISABLED;
...
$tlCfg->tree_filter_cfg->testcases->edit_mode->filter_testcase_name = DISABLED;
$tlCfg->tree_filter_cfg->testcases->edit_mode->filter_toplevel_testsuite = DISABLED;
$tlCfg->tree_filter_cfg->testcases->edit_mode->filter_keywords = DISABLED;
$tlCfg->tree_filter_cfg->testcases->edit_mode->filter_active_inactive = DISABLED;
$tlCfg->tree_filter_cfg->testcases->edit_mode->filter_importance = ENABLED;
$tlCfg->tree_filter_cfg->testcases->edit_mode->filter_execution_type = DISABLED;
$tlCfg->tree_filter_cfg->testcases->edit_mode->filter_custom_fields = ENABLED;
$tlCfg->tree_filter_cfg->testcases->edit_mode->filter_workflow_status = DISABLED;
...
$tlCfg->tree_filter_cfg->testcases->plan_mode->filter_testcase_name = DISABLED;
$tlCfg->tree_filter_cfg->testcases->plan_mode->filter_toplevel_testsuite = DISABLED;
$tlCfg->tree_filter_cfg->testcases->plan_mode->filter_keywords = DISABLED;
$tlCfg->tree_filter_cfg->testcases->plan_mode->filter_priority = ENABLED;
$tlCfg->tree_filter_cfg->testcases->plan_mode->filter_execution_type = DISABLED;
...
$tlCfg->tree_filter_cfg->testcases->plan_add_mode->filter_testcase_name = DISABLED;
$tlCfg->tree_filter_cfg->testcases->plan_add_mode->filter_toplevel_testsuite = DISABLED;
$tlCfg->tree_filter_cfg->testcases->plan_add_mode->filter_keywords = DISABLED;
$tlCfg->tree_filter_cfg->testcases->plan_add_mode->filter_active_inactive = DISABLED;
$tlCfg->tree_filter_cfg->testcases->plan_add_mode->filter_importance = ENABLED;
$tlCfg->tree_filter_cfg->testcases->plan_add_mode->filter_execution_type = DISABLED;
...
$tlCfg->tree_filter_cfg->requirements->filter_title = DISABLED;
$tlCfg->tree_filter_cfg->requirements->filter_status = DISABLED;
$tlCfg->tree_filter_cfg->requirements->filter_type = DISABLED;
$tlCfg->tree_filter_cfg->requirements->filter_spec_type = DISABLED;
$tlCfg->tree_filter_cfg->requirements->filter_coverage = DISABLED;
$tlCfg->tree_filter_cfg->requirements->filter_relation = DISABLED;
...
// 0 => do not check.
$tlCfg->custom_fields->max_length = 2555;
